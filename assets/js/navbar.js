(function () {
  ...
  var NAV_HTML = [
    ...
    '        <li class="nav-item">',
    '          <button type="button" class="nav-link" aria-haspopup="true">',
    '            Wines',
    ...
    '          </button>',
    '          <div class="nav-dropdown" role="menu">',
    '            <a href="/sparkling-wine/index.html" role="menuitem">South Africa</a>',
    '          </div>',
    '        </li>',
    ...
    '            <a href="/spirits/liquor.html" role="menuitem">Liqueur</a>',
    ...
    '  <details class="mobile-nav-group">',
    '    <summary>Sparkling Wine <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="6 9 12 15 18 9"/></svg></summary>',
    '    <div class="mobile-nav-sub">',
    '      <a href="/sparkling-wine/index.html">South Africa</a>',
    '    </div>',
    '  </details>',
    ...
    '      <a href="/spirits/liquor.html">Liqueur</a>',
